...
abstract class _$AppRouter extends RootStackRouter {
  ...
  final Map<String, PageFactory> pagesMap = {
    ...
    ProductPreviewRoute.name: (routeData) {
      return AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const ProductPreviewPage(),
      );
    },
...
/// generated route for
/// [DeliveryPointPage]
class DeliveryPointRoute extends PageRouteInfo<void> {
  const DeliveryPointRoute({List<PageRouteInfo>? children})
      : super(
          DeliveryPointRoute.name,
          initialChildren: children,
        );

  static const String name = 'DeliveryPointRoute';
...
/// generated route for
/// [ProductPreviewPage]
class ProductPreviewRoute extends PageRouteInfo<void> {
  const ProductPreviewRoute({List<PageRouteInfo>? children})
      : super(
